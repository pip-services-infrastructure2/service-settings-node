...
import { SettingsCommandableHttpServiceV1 } from '../services/version1/SettingsCommandableHttpServiceV1';
...
export class SettingsServiceFactory extends Factory {
	...
	public static CmdHttpServiceDescriptor = new Descriptor("service-settings", "service", "commandable-http", "*", "1.0");
	...
	constructor() {
		...
		this.registerAsType(SettingsServiceFactory.CmdHttpServiceDescriptor, SettingsCommandableHttpServiceV1);
