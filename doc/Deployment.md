...
var plugin = require('service-settings-node').SettingsSenecaPlugin;
...
or by using [SettingsSenecaClient](https://github.com/pip-services-infrastructure2/client-settings-node/NodeClientApiV1.md/#client_seneca)